class ShieldUI {
    ...
    renderShieldPanel() {
        ...
        return `
            <div id="shield-panel" style="position:absolute;top:20px;right:20px;width:280px;background:rgba(0,0,0,0.85);border:2px solid #00ff55;border-radius:6px;padding:12px;font-family:var(--font-tech);box-shadow:0 0 15px rgba(0,255,85,0.3);">
