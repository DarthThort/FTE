...
**Total extracted**: ~380 lines

---

## 📝 Manual Steps Required

### STEP 1: Add Module Instances to Constructor

**Location**: `js/game/GameState.js`, lines ~2-185 (constructor)

**FIND** (near beginning of constructor, after `this.fuel = 100`):
```javascript
...
**Then FIND** (at END of constructor, after all property initialization):
```javascript
        // Subscribe managers to state changes
        this.listeners = [];
    }
```
...
### STEP 2: Replace saveGame Method
